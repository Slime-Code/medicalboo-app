<template>
  ...
  <div class="column" style="min-width: 90%">
    <div class="col q-ma-xs">
      <div class="row">
        <h5 class="col-12 title" style="margin: 20px 0;">Tipo de Perfil</h5>
    ...
    <div class="col q-mt-md">
      <q-list bordered class="rounded-borders"
        style="min-width: 160px; width:100%;">
          <q-item-label header><strong>Lista de tipos de perfis</strong></q-item-label>
